...
/**
 * @ClassName SnmpSendUtil
 * @Author huangyb
 * @Date 2019/4/10 10:28
 * @Version 1.0
 */
public class SnmpSendUtil {
    ...
    public void initComm() throws IOException {
        ...
        // 设置管理进程的IP和端口
        targetAddress = GenericAddress.parse("udp:10.1.152.240/8162");
    ...
    public static void main(String[] args) {
        try {
            SnmpSendUtil util = new SnmpSendUtil();
            util.initComm();
            util.sendPDU();
        } catch (IOException e) {
            e.printStackTrace();
